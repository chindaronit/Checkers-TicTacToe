import pygame
from constants import ROWS,COLS,SQSIZE,BLACK,WHITE,BLACKPIECE,WHITEPIECE,WIDTH,HEIGHT,LIGHTWOOD
from pieces import Piece 


bg_img = pygame.image.load('wood.jpg')
...
class Board:
    ...
    def draw_squares(self, window):
        ...
        for row in range(ROWS):
            for col in range(row % 2, ROWS, 2):
                ...
                window.blit(LIGHTWOOD,(row * SQSIZE, col * SQSIZE, SQSIZE, SQSIZE))
    ...
    def evaluate(self):
        return (self.white_left-self.black_left)*2+(self.white_kings**0.5-self.black_kings**0.5)
